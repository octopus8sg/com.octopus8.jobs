...
CREATE TABLE `civicrm_o8_job` (
  ...
  `due_date` timestamp NULL DEFAULT NULL COMMENT 'Date and time the job proposal will expire',
...
CREATE TRIGGER o8_Job_Date
    BEFORE INSERT ON civicrm_o8_job
    FOR EACH ROW
    SET NEW.due_date = DATE_ADD(NOW(), INTERVAL 1 MONTH);
