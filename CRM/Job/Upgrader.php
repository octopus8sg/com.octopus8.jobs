 ...
 */
class CRM_Job_Upgrader extends CRM_Job_Upgrader_Base
{
...
//    $this->executeSqlFile('sql/myinstall.sql');
        ...
        try {
            $typeOptionGroupId = civicrm_api3('OptionGroup', 'create', ['name' => 'job_role', 'title' => E::ts('Role')]);
        ...
        try {
            ...
            $typeOptionGroupId = civicrm_api3('OptionGroup', 'create', ['name' => 'job_location', 'title' => E::ts('Location')]);
            $typeOptionGroupId = $typeOptionGroupId['id'];
            civicrm_api3('OptionValue', 'create',
                ['value' => 1,
                    'is_default' => '1',
...
//      $this->executeSqlFile('sql/myuninstall.sql');
        try {
            $optionGroupId = civicrm_api3('OptionGroup', 'getvalue', ['return' => 'id', 'name' => 'job_role']);
        ...
        try {
            $optionGroupId = civicrm_api3('OptionGroup', 'getvalue', ['return' => 'id', 'name' => 'job_location']);
            $optionValues = civicrm_api3('OptionValue', 'get', ['option_group_id' => $optionGroupId, 'options' => ['limit' => 0]]);
            foreach ($optionValues['values'] as $optionValue) {
                civicrm_api3('OptionValue', 'delete', ['id' => $optionValue['id']]);
            }
        ...
        try {
            $optionGroupId = civicrm_api3('OptionGroup', 'getvalue', ['return' => 'id', 'name' => 'job_status']);
            $optionValues = civicrm_api3('OptionValue', 'get', ['option_group_id' => $optionGroupId, 'options' => ['limit' => 0]]);
            foreach ($optionValues['values'] as $optionValue) {
                civicrm_api3('OptionValue', 'delete', ['id' => $optionValue['id']]);
            }
