 ...
 */
class CRM_Job_Upgrader_Base {

  /**
   * @var CRM_Job_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Job_Upgrader(
        'com.socialservicesconnect.job',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Job_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Job_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
