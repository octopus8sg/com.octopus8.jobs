 ...
 */
function _civicrm_api3_o8_application_create_spec(&$spec) {
 ...
 */
function civicrm_api3_o8_application_create($params) {
 ...
 * @throws API_Exception
 */
function civicrm_api3_o8_application_delete($params) {
 ...
 * @throws API_Exception
 */
function civicrm_api3_o8_application_get($params) {
