...
/**
 * Job.create API specification (optional).
 ...
 */
function _civicrm_api3_job_create_spec(&$spec) {
...
function civicrm_api3_job_get($params) {
  return _civicrm_api3_basic_get(_civicrm_api3_get_BAO(__FUNCTION__), $params, TRUE, 'Job');
}
