{crmScope extensionKey='com.socialservicesconnect.jobs'}
    <div class="crm-content-block">
        <div class="action-link">
            {*        {debug}*}
            <a class="button add-job" href="{crmURL p="civicrm/job/form" q="reset=1&action=add" }">
                <i class="crm-i fa-plus-circle">&nbsp;</i>
                {ts}Add Job{/ts}
            </a>
        </div>
        <div class="clear"></div>
        {include file="CRM/Job/Form/JobFilter.tpl"}
        <div class="clear"></div>
...
{crmScript ext=com.socialservicesconnect.jobs file=js/jobs.js}
{/crmScope}