    ...
    <div class="jobs-tab view-content">
        <div id="secondaryTabContainer1" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            ...
            <ul class="ui-tabs-nav ui-corner-all ui-helper-reset ui-helper-clearfix ui-widget-header">
                ...
                <li id="tab_jobs1" class="crm-tab-button ui-corner-all ui-tabs-tab ui-corner-top ui-state-default ui-tab">
                    <a href="#jobs-subtab1" title="{ts}Applications{/ts}">
                        {ts}Applications{/ts} <em>{$applicationCount}</em>
                    </a>
                </li>
            </ul>

            <div id="data-subtab1" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
                {include file="CRM/Jobs/Page/Tabs/EmployeeJobs.tpl"}
            </div>
            <div id="jobs-subtab1" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
                {include file="CRM/Jobs/Page/Tabs/EmployeeApplications.tpl"}
            </div>
            <div class="clear"></div>
        </div>
    </div>
