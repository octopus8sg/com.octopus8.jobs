            ...
            <div class="crm-accordion-wrapper crm-expenses_search-accordion">
                ...
                <div class="crm-accordion-body">
                    <table class="form-layout employer-job-filter">
                        ...
                        <tr>
                            <td class="label">{$form.employer_job_dateselect_from.label}</td>
                            <td>{$form.employer_job_dateselect_from.html}</td>
                            <td class="label">{$form.employer_job_dateselect_to.label}</td>
                            <td>{$form.employer_job_dateselect_to.html}</td>
                        </tr>
                        <tr>
                            <td class="label">{$form.employer_job_due_dateselect_from.label}</td>
                            <td>{$form.employer_job_due_dateselect_from.html}</td>
                            <td class="label">{$form.employer_job_due_dateselect_to.label}</td>
                            <td>{$form.employer_job_due_dateselect_to.html}</td>
                        </tr>
                        </tbody>
                    </table>
